package com.ccaong.xshare.view;
...
public class RadarScanView extends View {
    ...
    private void init(Context context) {
        mCircleColor = context.getResources().getColor(R.color.white);
        mArcColor = context.getResources().getColor(R.color.white);
        mLineColor = context.getResources().getColor(R.color.white);

        mArcStartColor = context.getResources().getColor(R.color.transparent);
        mArcEndColor = context.getResources().getColor(R.color.white);
